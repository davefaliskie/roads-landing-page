...
export default function Home() {
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'Yes. All core features are free. Additional premium tools are available as part of Roads Audio Plus.',
    },
    {
    ...
    <>
      ...
      <main id="main-content" className={styles.main}>
        ...
        <div id={styles.section_use_cases}>
          ...
          <div className="container">
            <div className="row">
              <UseCase imagePath="/images/icons/note.svg" title="Record voice notes for yourself" />
              <UseCase
                imagePath="/images/icons/chat.svg"
                title="Stay in touch with a friend on a different schedule"
              />
              <UseCase imagePath="/images/icons/book.svg" title="Run a virtual book club" />
              <UseCase
        ...
        <div id={styles.section_wait_list}>
          ...
          <p className="text-center mx-1">
            Start your first voice thread today and feel closer to the people who matter.
          </p>
          <AppLinks />
        </div>
      </main>
