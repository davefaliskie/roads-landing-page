...
export default function Travel() {
  const appleStoreUrl =
    'https://apps.apple.com/us/app/roads-audio-voice-threads/id6443961864?ppid=22dd30d4-c186-402e-82a9-6dec5fda81f6';
  const googlePlayUrl =
    'https://play.google.com/store/apps/details?id=com.onemanstartup.roads&listing=travel';
    ...
    <>
      <main className={styles.main}>
        ...
        <div id={styles.section_features}>
          <h2 className="h2-lg my-lg text-center">
            Built for real conversations, no matter the distance
          </h2>
          ...
          <div className="container">
            <div className="row justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 offset-lg-1 my-auto text-center text-md-start">
                ...
                <p>
                  Comment on any moment in a voice message. Keep the conversation natural and
                  connected.
                </p>
              </div>
            </div>
            ...
            <div className="row my-5 justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 my-auto order-md-first text-center text-md-start">
                ...
                <p>
                  Each response is tied to the exact part of the audio it refers to. Listening feels
                  effortless.
                </p>
              </div>
            </div>
            ...
            <div className="row justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 offset-lg-1 my-auto text-center text-md-start">
                ...
                <p>
                  Create private voice spaces for your friends or family. Only the people you invite
                  can join.
                </p>
              </div>
            </div>
        ...
        <div id={styles.section_wait_list}>
          <h2 className="h2-lg text-center text-primary mx-1">
            Keep your circle close, wherever you go
          </h2>
          <p className="text-center mx-1">
            Start a voice thread today and stay connected across time zones.
          </p>
