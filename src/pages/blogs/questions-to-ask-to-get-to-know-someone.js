...
export default function Blog() {
  const slug = '/blogs/questions-to-ask-to-get-to-know-someone';
      ...
      <main id="main-content">
        <div id="blog-content" className="container">
          <div className="col-md-10 col-lg-8 col-xl-6 mx-auto">
            ...
            <p className="mt-4">
              Getting to know someone better doesn't always require long conversations or perfectly
              timed calls. Often, it starts with one thoughtful question and the space to answer it
              honestly.
            </p>

            <p>
              Whether you're reconnecting with a friend or just checking in, the right question can
              turn a quick message into something more meaningful. These questions are easy to ask,
              easy to answer, and work well in short voice messages or longer reflections.
            </p>

            <p className="my-4 lead highlight">
              Tip: pick one question, answer it as a voice message, and invite a friend to share
              their thoughts.
            </p>

            <h2>Light Check-In Questions</h2>

            <p>Simple, low-pressure questions that are easy to answer and easy to send.</p>

            <p>
              Sometimes the hardest part is starting. These questions are perfect for breaking the
              ice without making it feel like a big conversation.
            </p>
            ...
            <p>Thoughtful prompts that help someone reflect and share more meaningfully.</p>

            <p>
              These questions work especially well when you're catching up or continuing a
            ...
            <p>Questions designed to move past surface-level updates.</p>

            <p>
              These are best used with people you already know and want to connect with on a deeper
              level.
            </p>
            ...
            <p>Unexpected questions that often lead to more honest answers.</p>

            <p>These work especially well as voice messages, where pauses and tone add meaning.</p>
            ...
            <p>Light, simple questions that are easy to answer but still say something real.</p>

            <p>
              These work especially well when you want to send a short voice message without
              overthinking it.
            </p>
            ...
            <p>Questions that invite intention without feeling overwhelming.</p>

            <p>These are great for conversations that unfold gradually over time.</p>
            ...
            <p>
              You don't need to answer all of these questions or wait for the perfect moment. Pick
              one, record a short voice message, and send it. Sometimes that's all it takes to stay
              connected.
            </p>

            <p>
              If you want a simple way to have these kinds of conversations without needing to be
              online at the same time, Roads Audio is built for exactly that. It lets you share
              voice messages, respond when it works for you, and keep the full context of the
              conversation over time.
            </p>

            <p>Download Roads Audio and try it with a friend.</p>
