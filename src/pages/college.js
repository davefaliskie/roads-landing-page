    ...
    <>
      <main className={styles.main}>        
          ...
          <div className="container">
            ...
            <div className="row justify-content-md-center">
              ...
              <div className='col-md-6 col-lg-4 offset-lg-1 my-auto text-center text-md-start'>
                ...
                <p>Create private voice spaces just for your group. Only the friends you invite are there.</p>
              </div>
            </div>
        ...
        <div id={styles.section_wait_list}>
          <h2 className='h2-lg text-center text-primary mx-1'>Keep your college friendships alive</h2>
          <p className='text-center mx-1'>Start a voice thread today and stay close, even as life gets busy.</p>
