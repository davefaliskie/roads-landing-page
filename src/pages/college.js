...
export default function College() {
  const appleStoreUrl =
    'https://apps.apple.com/us/app/roads-audio-voice-threads/id6443961864?ppid=71c0158b-dcfd-4138-80d2-50f0a6afd3f9';
  const googlePlayUrl =
    'https://play.google.com/store/apps/details?id=com.onemanstartup.roads&listing=college';
    ...
    <>
      <main className={styles.main}>
        ...
        <div id={styles.section_features}>
          <h2 className="h2-lg my-lg text-center">Built for staying close after college</h2>
          ...
          <div className="container">
            <div className="row justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 offset-lg-1 my-auto text-center text-md-start">
                <h3>Catch up like you used to</h3>
                <p>
                  Send voice updates that feel natural and personal, just like talking together.
                </p>
              </div>
            </div>
            ...
            <div className="row my-5 justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 my-auto order-md-first text-center text-md-start">
                <h3>Reply on your own time</h3>
                <p>Friends listen and respond when it fits their day, no pressure to keep up.</p>
              </div>
            </div>
            ...
            <div className="row justify-content-md-center">
              ...
              <div className="col-md-6 col-lg-4 offset-lg-1 my-auto text-center text-md-start">
                <h3>Your college friend group</h3>
                <p>
                  Create private voice spaces just for your group. Only the friends you invite are
                  there.
                </p>
              </div>
            </div>
        ...
        <div id={styles.section_use_cases}>
          <h2 className="h2-lg my-lg text-center">How college friends use Roads</h2>
          <div className="container">
            <div className="row">
              <UseCase
                imagePath="/images/icons/update.svg"
                title="Send life updates to your college friends"
              />
              <UseCase
                imagePath="/images/icons/time.svg"
                title="Catch up when you finally have a free moment"
              />
              <UseCase
                imagePath="/images/icons/note.svg"
                title="Send long voice updates, no scheduling"
              />
              <UseCase
                imagePath="/images/icons/branch.svg"
                title="Reply to specific moments in a friend's update"
              />
              <UseCase
                imagePath="/images/icons/team.svg"
                title="Stay connected when group chats fade"
              />
              <UseCase
                imagePath="/images/icons/shared_audio.svg"
                title="Create a shared voice space for your group"
              />
            </div>
          </div>
        </div>
        ...
        <div id={styles.section_faq}>
          <h2 className="h2-lg my-lg text-center">Common Questions</h2>
        ...
        <div id={styles.section_wait_list}>
          <h2 className="h2-lg text-center text-primary mx-1">
            Keep your college friendships alive
          </h2>
          <p className="text-center mx-1">
            Start a voice thread today and stay close, even as life gets busy.
          </p>
